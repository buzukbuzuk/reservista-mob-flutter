...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    reservistaAuthUserSubject.add(
      ReservistaAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ReservistaAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ReservistaAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ReservistaAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    reservistaAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
ReservistaAuthUser? currentUser;
